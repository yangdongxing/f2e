...
function(a, b) {
    function c(a) {
        ...
        for (var c = a.parentNode; "inline" === b(c, "display"); )
            c = c.parentNode;
        return c
    }
    function d(a) {
...
function() {
    ...
    if (b && ("true" !== b.getItem("hideAppPromotionBar") && (a.className += " show-app-promotion-bar"),
...
function(a, b, c) {
        ...
        for (var i in s)
            if (s.hasOwnProperty(i)) {
                ...
                f = 0; f < a.length; f++)
                    g = a[f],
                    h = g.split("."),
                    1 === h.length ? u[h[0]] = e : (!u[h[0]] || u[h[0]] instanceof Boolean || (u[h[0]] = new Boolean(u[h[0]])),
                    u[h[0]][h[1]] = e),
                    v.push((e ? "" : "no-") + h.join("-"))
            }
    }
    function f(a) {
        ...
        u._config.enableClasses && (b += " " + c + a.join(" " + c),
        x ? w.className.baseVal = b : w.className = b)
    }
    function g(a, b) {
        return !!~("" + a).indexOf(b)
    }
    ...
    function j(a, c, d, e) {
        ...
        w.style.overflow = k,
        w.offsetHeight) : m.parentNode.removeChild(m),
        !!g
    }
    function k(a) {
    ...
    function l(b, d) {
        ...
        if ("CSSSupportsRule" in a) {
            for (var f = []; e--; )
                f.push("(" + k(b[e]) + ":" + d + ")");
            return f = f.join(" or "),
            j("@supports (" + f + ") { #modernizr { position: absolute; } }", function(a) {
    ...
    function n(a, b, e, f) {
        ...
        if (f = d(f, "undefined") ? !1 : f,
        !d(e, "undefined")) {
            var j = l(a, e);
            if (!d(j, "undefined"))
                return j
        }
        for (var k, n, o, p, q, r = ["modernizr", "tspan"]; !D.style; )
            k = !0,
            D.modElem = h(r.shift()),
    ...
    function p(a, b, c) {
        ...
        for (var f in a)
            if (a[f] in b)
                return c === !1 ? a[f] : (e = b[a[f]],
                d(e, "function") ? o(e, c || b) : e);
        return !1
    }
    function q(a, b, c, e, f) {
        var g = a.charAt(0).toUpperCase() + a.slice(1)
          , h = (a + " " + B.join(g + " ") + g).split(" ");
        return d(b, "string") || d(b, "undefined") ? n(h, b, e, f) : (h = (a + " " + z.join(g + " ") + g).split(" "),
        p(h, b, c))
    }
    function r(a, b, d) {
        return q(a, c, c, b, d)
    ...
    t.prefixed = function(a, b, c) {
        return 0 === a.indexOf("@") ? E(a) : (-1 != a.indexOf("-") && (a = m(a)),
        b ? q(a, b, c) : q(a, "pfx"))
    }
    ;
    t.testAllProps = r;
